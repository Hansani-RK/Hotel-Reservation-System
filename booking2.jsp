...
<div id="nav">
  ...
  <a href="contact.html">  <img src="NAVIGATION/contact.jpg"  height="80" width="auto" id="comments" onmousemove="src='NAVIGATION/contact select.jpg'" onmouseout="src='NAVIGATION/contact.jpg'"/></a>
		...
		<%! String cna,add,bv; int ac,non,v1,v2,v;%>
		...
		<%
			...
			bv=request.getParameter("op");
			
			
			try{
			
			Class.forName("com.mysql.jdbc.Driver");
			String path="jdbc:mysql://localhost/hotel_ex_1";
			Connection cn;
			Statement st;
			ResultSet rs;
			...
			st.executeUpdate("insert into client(C_name,address,ac,hotel,non) values('"+cna+"','"+add+"','"+ac+"','"+bv+"','"+non+"')");
...
<!--
<tr height="50px">
<td>Meal cost :-</td><td align="center"><input type="text" id="mcost" ></td>
</tr>
-->
